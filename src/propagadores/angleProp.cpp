...
public:
  ...
  tiltProp(OZ_Term tiltAnt, OZ_Term group,OZ_Term hAnt, OZ_Term hRB,OZ_Term distance, OZ_Term dif) : _tiltAnt(tiltAnt), _group(group), _heigthAnt(hAnt), _heigthRB(hRB),_distance(distance),_dif(dif){} 
